import { IsString, IsNumber, IsNotEmpty, IsOptional, IsBoolean, MinLength, MaxLength } from 'class-validator';
...
export class CreateRoleDto {
  ...
  @ApiPropertyOptional({ description: 'Role description', example: 'Technical engineer role' })
  @IsString()
  @IsOptional()
  description?: string;
...
export class RoleDto {
  ...
  @ApiPropertyOptional({ description: 'Role description', example: 'Technical engineer role', nullable: true })
